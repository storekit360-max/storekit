...
const tenantSchema = new mongoose.Schema({
  ...
  settings: {
    ...
    loaderLogoUrl: { type: String, default: '' },
    footerLogoUrl: { type: String, default: '' },
    searchLogoUrl: { type: String, default: '' },
    navbarLogoSize: { type: Number, default: 56 },
    loaderLogoSize: { type: Number, default: 86 },
    footerLogoSize: { type: Number, default: 56 },
    searchLogoSize: { type: Number, default: 32 },
