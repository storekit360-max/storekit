...
const STOREKIT_ASSISTANT_PAYMENT_POLICY = [
  ...
  'Verify checkout totals from the order record when available: subtotal, shipping cost, tax, coupon discount, gift voucher discount, total, payment method, currency, billing presence, and order creation timestamp.',
...
const ADMIN_NAVIGATION_ITEMS = [
  ...
  { key: 'giftCards', label: 'Gift Vouchers', path: '/admin/gift-cards', feature: 'giftCards', aliases: ['gift vouchers', 'gift voucher', 'voucher'] },
...
const SETTINGS_TABS = [
  ...
  { id: 'discounts', label: 'Discounts', path: '/admin/settings', feature: 'coupons', aliases: ['discounts', 'coupon settings', 'gift voucher covers delivery', 'discount priority'] },
  { id: 'features', label: 'Features', path: '/admin/settings', feature: null, aliases: ['features', 'wishlist', 'reviews', 'returns', 'guest checkout', 'gift vouchers'] },
  ...
  switch (tab.id) {
    ...
    case 'features':
      return [
        ...
        `Gift Vouchers: ${settings.enableGiftCards ? 'Enabled' : 'Disabled'}`,
...
function buildPaymentLiveAnswer(ctx, order, gatewayResult, returnResult) {
  ...
  const findings = [
    ...
    `Gift Voucher Discount: ${money(o.giftCardDiscount, currency)}`,
    `Total: ${money(o.total, currency)}`,
