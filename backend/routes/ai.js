...
const ADMIN_KNOWLEDGE = [
  ...
  },
  {
    ...
    answer: [
      ...
      '',
      'For creative AI post design, open Admin -> AI Post Creator, select a product, generate the creative/caption, choose a connected platform, then click Publish Now.',
    ].join('\n'),
  },
  {
    id: 'categories',
...
const FEATURE_ROUTES = {
  ...
  aiPostCreator: '/admin/ai-post-creator',
...
const ADMIN_NAVIGATION_ITEMS = [
  ...
  { key: 'aiPostCreator', label: 'AI Post Creator', path: '/admin/ai-post-creator', feature: 'aiPostCreator', aliases: ['ai post creator', 'ai post', 'creative post'] },
